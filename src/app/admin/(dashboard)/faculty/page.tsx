          ...
          >
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-full bg-[#192538] text-white flex items-center justify-center font-serif text-lg font-bold">
              ...
              <div className="text-xs text-[#192538]">
                <strong className="block mb-1">Expertise:</strong>
                <div className="flex flex-wrap gap-1">
                  {fac.expertiseAreas.map((exp, i) => (
                    <span key={i} className="text-[10px] bg-[#FAF7F0] border border-[#E2D7C3] px-2 py-0.5 rounded">
                      {exp}
                    </span>
                  ))}
                </div>
