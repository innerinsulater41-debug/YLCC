  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-8">
      <div className="border-b border-[#E8DFC8] pb-4">
        <h1 className="text-3xl font-serif font-bold text-[#192538]">Institutional Disclaimer</h1>
      ...
      <div className="space-y-6 text-sm text-[#57534E] leading-relaxed">
        <section className="space-y-2">
          <h2 className="text-lg font-serif font-bold text-[#192538]">1. Nature of Institute & Programs</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-serif font-bold text-[#192538]">2. No Statutory Professional Authorization</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-serif font-bold text-[#192538]">3. Employment & Placement Assistance</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-serif font-bold text-[#192538]">4. Educational Case Studies</h2>
          <p>
