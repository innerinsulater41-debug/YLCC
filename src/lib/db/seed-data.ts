...
export const initialInstituteSettings: InstituteSettings = {
  ...
  address: 'Barra-4, L.I.G-20, Kanpur, Uttar Pradesh, India',
  officeHours: 'Monday – Saturday: 8:30 AM – 7:30 PM (Sunday Closed)',
  socialLinks: {
    instagram: 'https://instagram.com/ylcc_commerce',
    facebook: 'https://facebook.com/ylcccommerce',
    linkedin: 'https://linkedin.com/company/ylcc-commerce',
  ...
  heroTitle: 'Master Real-World Accounting & Taxation with Multi-Business Practical Projects',
  heroSubtitle:
  ...
  announcementBarText: '📢 Admissions Open for Upcoming Practical Batches — Limited to 20 Students per Cohort for 1-on-1 Mentorship!',
...
export const initialPrograms: Program[] = [
  {
    ...
    title: 'Business Operations with Tally Prime',
    ...
    certificateInfo: 'YLCC Verified Business Operations with Tally Prime Certification upon practical ledger evaluation',
    isFeatured: true,
    status: 'published',
    displayOrder: 1,
    ...
    seoTitle: 'Business Operations with Tally Prime Course | Practical Accounting Training Jaipur | YLCC',
    seoDescription:
...
export const initialFaculty: Faculty[] = [
  {
    id: 'fac-1',
    name: 'CA Alok Maheshwari',
    designation: 'Senior Faculty & Tax Consultant',
    qualifications: 'FCA (Fellow Chartered Accountant), B.Com (Hons.)',
    experienceYears: 18,
    expertiseAreas: [
      'Corporate Taxation',
      'GST Appeals & Audit',
      'TDS/TCS Litigation',
      'Accounts Manager Supervision',
      'Statutory Income Tax Audits',
    ],
    programsTaught: ['Accounts Manager', 'GST Practitioner', 'TDS/TCS Practitioner'],
    bio: 'CA Alok Maheshwari has over 18 years of active practice in corporate taxation, statutory audits, and GST advisory for industrial enterprises across Rajasthan and NCR. He is renowned for his practical, no-nonsense teaching methodology that turns complex tax laws into systematic, step-by-step accounting workflows.',
    photoUrl: '/images/ylcc_tds_brochure_slate_copper.png',
    linkedinUrl: 'https://linkedin.com',
    email: 'alok.maheshwari@ylcccommerce.in',
    isFeatured: true,
    displayOrder: 1,
  },
  {
    id: 'fac-2',
    name: 'Rajesh Soni',
    designation: 'Head of Accounting & Banking Operations',
    qualifications: 'M.Com, PGD in Banking & Financial Operations, Tally Certified Professional',
    experienceYears: 15,
    expertiseAreas: [
      'Commercial Banking & CC Limits',
      'CMA Data Preparation',
      'Industrial Cost Accounting',
      'Accounts Operator Live Training',
      'Government Contractor Site Costing',
    ],
    programsTaught: ['Accounts Operator', 'Banking CC Limits & CMA', 'Cost Accounting & Industrial Inventory'],
    bio: 'With 15 years leading finance and accounting operations in large manufacturing conglomerates and commercial banking documentation desks, Rajesh Soni specializes in live voucher entries, Drawing Power computations, bank stock statements, and multi-business costing systems.',
    photoUrl: '/images/ylcc_tds_brochure_maroon.png',
    linkedinUrl: 'https://linkedin.com',
    email: 'rajesh.soni@ylcccommerce.in',
    isFeatured: true,
    displayOrder: 2,
  },
  {
    id: 'fac-3',
    name: 'CS Meenakshi Sharma',
    designation: 'Faculty - Corporate Law & Payroll Compliance',
    qualifications: 'ACS (Company Secretary), LL.B, M.Com',
    experienceYears: 12,
    expertiseAreas: [
      'Corporate Payroll Architecture',
      'Indian Labour Laws & Factory Acts',
      'EPF & ESIC Portal Operations',
      'Bonus & Gratuity Provisioning',
      'Commercial Legal Contracts',
    ],
    programsTaught: ['Corporate Payroll Management', 'Accounts Manager Legal Module'],
    bio: 'CS Meenakshi Sharma is a seasoned Company Secretary and corporate legal advisor advising mid-size and large corporations on employee benefits, statutory payroll audits, Labour Law compliance, and workforce structuring.',
    photoUrl: '/images/ylcc_tds_brochure_espresso_sage_improved.png',
    linkedinUrl: 'https://linkedin.com',
    email: 'meenakshi.sharma@ylcccommerce.in',
    isFeatured: true,
    displayOrder: 3,
  },
  {
    ...
    designation: 'Senior Corporate MIS Analyst & Excel Specialist',
    qualifications: 'B.Com, MCA, Microsoft Certified Excel Expert',
    experienceYears: 10,
    expertiseAreas: [
      'Excel 365 Dynamic Arrays (LET, LAMBDA)',
      'Power Query & Data Modeling',
      'Automated Corporate MIS Dashboards',
      '500+ Excel Error Recovery Techniques',
      'Technical Accounting Interview Coaching',
    ],
    programsTaught: ['Advanced Excel & Corporate Excel 365'],
    bio: 'Vikas Khandelwal has trained thousands of commerce graduates and financial analysts in advanced spreadsheet modeling. His corporate workshops focus on eliminating manual data entry through Power Query automations and executive dashboard creation.',
    photoUrl: '/images/ylcc_tds_brochure_v2.png',
    linkedinUrl: 'https://linkedin.com',
    email: 'vikas.khandelwal@ylcccommerce.in',
    isFeatured: true,
    displayOrder: 4,
  },
];
...
export const initialTestimonials: Testimonial[] = [
  {
    ...
    courseTaken: 'Accounts Operator & GST Practitioner',
    currentRole: 'Senior Accounts Executive',
    company: 'Apex Logistics & Freight Corp',
    quote:
      'Before joining YLCC, I had completed B.Com but had never seen an actual GST invoice, let alone filed a GSTR-3B return. At YLCC, practicing on actual bills from 30 different businesses gave me the real experience of someone with 2 years on the job. Within three weeks of finishing, I cleared my interview with complete confidence.',
    rating: 5,
    avatarUrl: '/images/ylcc_tds_brochure_slate_copper.png',
    isFeatured: true,
  },
  {
    id: 'test-2',
    studentName: 'Priya Verma',
    courseTaken: 'TDS/TCS Practitioner & Corporate Payroll',
    currentRole: 'Taxation & Payroll Officer',
    company: 'Khandelwal & Associates CA Firm',
    quote:
      'The TDS return filing module using actual NSDL RPU software and TRACES portal training is unmatched anywhere else. I was able to handle quarterly Form 26Q and Form 24Q filing right from my first week at the CA firm without needing any supervision.',
    rating: 5,
    avatarUrl: '/images/ylcc_tds_brochure_maroon.png',
    isFeatured: true,
  },
  {
    id: 'test-3',
    studentName: 'Mohit Pareek',
    courseTaken: 'Advanced Excel 365 & Banking CC Limits',
    currentRole: 'MIS & Finance Analyst',
    company: 'Rajasthan Healthcare Ltd',
    quote:
      'The 250+ Excel formulas and real CMA project training changed my career trajectory. Learning how banks evaluate Drawing Power and building automated hospital billing sheets in Excel 365 gave me practical skills that directly doubled my value in corporate interviews.',
    rating: 5,
    avatarUrl: '/images/ylcc_tds_brochure_v2.png',
    isFeatured: true,
  },
  {
    id: 'test-4',
    studentName: 'Anjali Agarwal',
    courseTaken: 'Accounts Manager & Cost Accounting',
    currentRole: 'Accounts Manager',
    company: 'Royal Heritage Boutique Resorts',
    quote:
      'YLCC does not teach bookish definitions; they teach actual corporate desk work. The hotel business accounting project and internal audit checklists enabled me to step straight into an Accounts Manager role and monitor debtors cycles effectively.',
    rating: 5,
    avatarUrl: '/images/ylcc_tds_brochure_espresso_sage_improved.png',
    isFeatured: true,
  },
];
...
export const initialFAQs: FAQ[] = [
  {
    ...
    question: 'How is YLCC different from ordinary computer training institutes?',
    answer:
      'YLCC is exclusively a commerce and professional accounting training institute—we do not teach coding or general basic computer courses. Every training topic is grounded in actual business documents: sales registers, tax invoices, bank stock statements, E-way bills, TDS certificates, and government portals. Students work on authentic practical projects across 30 different business industries (Hospitals, Hotels, Logistics, Builders, Government Contractors, FMCG, etc.).',
  },
  {
    id: 'faq-2',
    category: 'Admissions',
    question: 'What educational qualification is required to enroll?',
    answer:
      'Anyone with a commerce background—including Class 12th Commerce students, B.Com, BBA, M.Com, MBA Finance graduates, CA/CS inter students, as well as working accountants and business owners looking to master their books—is welcome. Prior computer experience is not required as we start from live voucher feeding and build up to advanced audits.',
  },
  {
    id: 'faq-3',
  ...
  },
  {
    ...
    question: 'Do I get a verified certificate upon course completion?',
    answer:
      'Yes, YLCC issues practical skill completion certificates verifying hands-on competence in accounting operations, GST, TDS/TCS, Payroll, and Advanced Excel. Certificates are awarded upon successful evaluation of your practical case study ledgers. We also offer career guidance, resume structuring for finance desks, and interview preparation covering 250+ real corporate accounting interview questions.',
  },
  {
    id: 'faq-5',
    category: 'Batches & Timings',
    question: 'What batch options are available for working professionals and college students?',
    answer:
      'We offer flexible batch schedules: Early Morning (7:30 AM – 9:30 AM), Regular Morning (10:00 AM – 12:00 PM), Evening (5:00 PM – 7:00 PM & 6:30 PM – 8:30 PM), and Weekend Executive Cohorts (Saturday & Sunday). Batches are strictly capped at 15–20 students to guarantee personalized 1-on-1 practical ledger guidance.',
  },
  {
    id: 'faq-6',
    category: 'Curriculum & Software',
    question: 'Which software tools are taught during the courses?',
    answer:
      'Students gain hands-on proficiency in Tally Prime 4.0 (with multi-user and multi-cost-center features), Busy Accounting Software, Microsoft Excel 365 (including Power Query, Dynamic Arrays, and MIS modeling), the official GST Portal and GST Offline Tool, the NSDL RPU and FVU e-TDS return utilities, TRACES Portal, and the Unified EPF and ESIC compliance portals.',
  },
];
...
export const initialResources: ResourceItem[] = [
  {
    id: 'res-1',
    title: 'YLCC 30 Multi-Business Practical Projects Master Dossier',
    category: 'Course Brochures',
    description: 'Comprehensive curriculum brief outlining all 30 multi-business accounting projects and learning modules.',
    fileUrl: '/sample-docs/YLCC-16-Multi-Business-Practical-Projects.pdf',
    fileType: 'pdf',
    fileSize: '59 KB',
    accessLevel: 'public',
    downloadCount: 348,
  ...
  {
    id: 'res-2',
    title: 'Accounts Operator & Manager Complete Syllabus Guide',
    category: 'Course Brochures',
    description: 'Detailed topic-by-topic syllabus for Accounts Operator and Accounts Manager professional training programs.',
    fileUrl: '/sample-docs/YLCC-Course-Accounts-Operator-Manager.pdf',
    fileType: 'pdf',
    fileSize: '58 KB',
    accessLevel: 'public',
    downloadCount: 412,
  ...
  {
    id: 'res-3',
    title: 'Banking Operations, CC Limits & GST Practitioner Brochure',
    category: 'GST Compliance',
    description: 'Brochure covering bank loan limit documentation, monthly Drawing Power, stock statements, and GST return filing.',
    fileUrl: '/sample-docs/YLCC-Course-Banking-GST.pdf',
    fileType: 'pdf',
    fileSize: '61 KB',
    accessLevel: 'public',
    downloadCount: 295,
  ...
  {
    id: 'res-4',
    title: 'TDS/TCS & Corporate Payroll Training Curriculum',
    category: 'TDS/TCS Resources',
    description: 'Detailed breakdown of withholding tax sections, quarterly returns 24Q/26Q, salary structuring, and Labour Laws.',
    fileUrl: '/sample-docs/YLCC-Course-TDS-Payroll.pdf',
    fileType: 'pdf',
    fileSize: '60 KB',
    accessLevel: 'public',
    downloadCount: 310,
  ...
  {
    id: 'res-5',
    title: 'Industrial Cost Accounting & Advanced Excel 365 Guide',
    category: 'Excel Practice Files',
    description: 'Guide detailing 250+ Excel formulas, 500+ troubleshooting techniques, BOM costing, and site costing workflows.',
    fileUrl: '/sample-docs/YLCC-Course-Costing-Excel.pdf',
    fileType: 'pdf',
    fileSize: '64 KB',
    accessLevel: 'public',
    downloadCount: 520,
  ...
  {
    id: 'res-6',
    title: 'Commercial Bank Stock Statement & Drawing Power Format',
    category: 'Sample Accounting Formats',
    description: 'Standard banking monthly stock statement format with margin deduction and debtor aging calculation sheets.',
    fileUrl: '/sample-docs/YLCC-Course-Banking-GST.pdf',
    fileType: 'pdf',
    fileSize: '60 KB',
    accessLevel: 'student',
...
export const initialGallery: GalleryItem[] = [
  {
    id: 'gal-1',
    albumCategory: 'Classroom & Accounting Lab',
    title: 'Hands-on Tally Prime & Live Invoice Feeding Lab',
    caption: 'Students practicing live sales billing, purchase registers, and voucher verification in the YLCC Accounting Lab.',
    imageUrl: '/images/ylcc_tds_brochure_slate_copper.png',
    date: 'February 2026',
  },
  {
    id: 'gal-2',
    albumCategory: 'GST & Taxation Workshops',
    title: 'GSTR-2B vs Purchase Book Milan Workshop',
    caption: 'Specialized Saturday workshop on resolving ITC discrepancies and preparing monthly GSTR-3B offsets.',
    imageUrl: '/images/ylcc_tds_brochure.png',
    date: 'January 2026',
  },
  {
    id: 'gal-3',
    albumCategory: 'Advanced Excel Masterclass',
    title: 'Corporate Excel 365 Dynamic Arrays & MIS Dashboards',
    caption: 'Interactive masterclass on building executive financial dashboards using XLOOKUP, FILTER, and Power Query.',
    imageUrl: '/images/ylcc_tds_brochure_v2.png',
    date: 'December 2025',
  },
  {
    id: 'gal-4',
    albumCategory: 'Project Presentations',
    title: 'Hospital & Construction Site Costing Case Study Review',
    caption: 'Students presenting final project ledger balances and internal audit checklists before our CA panel.',
    imageUrl: '/images/ylcc_tds_brochure_espresso_sage_improved.png',
    date: 'November 2025',
  },
  {
    id: 'gal-5',
    albumCategory: 'Seminars & Guest Lectures',
    title: 'Commercial Banking CC Limits & Drawing Power Seminar',
    caption: 'Guest lecture by senior bank credit managers on CMA data preparation and working capital assessment.',
    imageUrl: '/images/ylcc_tds_brochure_maroon.png',
    date: 'October 2025',
  },
];
...
export const initialEnquiries: Enquiry[] = [
  {
    ...
    email: 'suresh.choudhary@gmail.com',
    phone: '+91 94140 55432',
    programOfInterest: 'GST Practitioner Practical Masterclass',
    preferredBatch: 'Evening Batch (6:30 PM)',
    message: 'I am a B.Com graduate and want to start GST return filing for local businesses. Please let me know the upcoming batch starting date.',
    status: 'new',
    createdAt: '2026-02-28T10:15:00Z',
    notes: 'Inquired about weekend vs weekday evening batches.',
  },
  {
    id: 'enq-2',
    name: 'Kavita Mathur',
    email: 'kavita.mathur@yahoo.com',
    phone: '+91 98291 44321',
    programOfInterest: 'Corporate Payroll Management & Statutory Compliance',
    preferredBatch: 'Morning Batch (10:00 AM)',
    message: 'Working in HR administration, looking to master EPF, ESIC, and salary structuring according to Labour Laws.',
    status: 'contacted',
    createdAt: '2026-02-25T14:30:00Z',
    notes: 'Counselor shared course syllabus and batch timings over WhatsApp.',
  },
];
...
export const initialApplications: AdmissionApplication[] = [
  {
    ...
    email: 'amit.bansal99@gmail.com',
    phone: '+91 97820 88765',
    dob: '2001-05-14',
    address: '42, Mansarovar Sector 7, Jaipur, Rajasthan 302020',
    qualification: 'B.Com (Commerce Graduate)',
    commerceBackground: true,
    selectedProgram: 'accounts-manager',
    preferredMode: 'Offline Classroom',
    preferredBatch: 'Morning: 10:30 AM – 12:30 PM',
    currentOccupation: 'Junior Accountant (Seeking Promotion)',
    careerGoal: 'To independently manage books of accounts and internal audits for manufacturing firms.',
    documentUrls: ['/sample-docs/YLCC-Course-Accounts-Operator-Manager.pdf'],
    consent: true,
    status: 'under_review',
    adminNotes: 'Candidate has 8 months of basic billing experience; good fit for Accounts Manager cohort.',
