  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-8">
      <div className="border-b border-[#E5D8CA] pb-4">
        <h1 className="text-3xl font-serif font-bold text-[#2A1810]">Refund & Cancellation Policy</h1>
      ...
      <div className="space-y-6 text-sm text-[#57534E] leading-relaxed">
        <section className="space-y-2">
          <h2 className="text-lg font-serif font-bold text-[#2A1810]">1. Seat Reservation Fee</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-serif font-bold text-[#2A1810]">2. Cancellation Prior to Batch Commencement</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-serif font-bold text-[#2A1810]">3. Batch Transfer Flexibility</h2>
          <p>
